#pragma checksum "D:\YNK_Crm\WebManage\Areas\Admin\Views\Manage\CourseWork\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "aae0434aef6d5ce7d1359f7f6b751096bc6499f8"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Areas_Admin_Views_Manage_CourseWork_Index), @"mvc.1.0.view", @"/Areas/Admin/Views/Manage/CourseWork/Index.cshtml")]
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"aae0434aef6d5ce7d1359f7f6b751096bc6499f8", @"/Areas/Admin/Views/Manage/CourseWork/Index.cshtml")]
    ...
    public class Areas_Admin_Views_Manage_CourseWork_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
...
<div class=""layui-fluid"">
    <div class=""layui-card"">
        <div class=""layui-card-body"">
                ...
                <div class=""layui-form-item"">
                    <div class=""layui-inline"">
                        ...
                        <div class=""layui-input-inline mr0"">
                            <input id=""txtTitle"" class=""layui-input"" type=""text"" placeholder=""学员或者教师"" />
                        </div>
                    </div>
                    <div class=""layui-inline"">
            ...
            WriteLiteral(@"bel w-auto"">科目：</label>
                        <div class=""layui-input-inline mr0"">
...
<div class=""layui-tab layui-tab-card"" lay-filter=""tabWork"" style=""margin-top:0px"">
    ...
    <div class=""layui-tab-content"" style=""padding:0px;"">
        <div class=""layui-tab-item");
            WriteLiteral(@" layui-show"" style=""padding-top:10px;"">
            <div id='calendar'></div>
        </div>
        <div class=""layui-tab-item"" style=""padding-top:10px"">
            ...
            <table class=""layui-table"" id=""userT");
            WriteLiteral("able\" lay-filter=\"userTable\"></table>\r\n        </div>\r\n    </div>\r\n</div>\r\n<div style=\"position:absolute;background-color:yellowgreen\" id=\"flexPlay\"></div>\r\n");
...
");
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        //            preMonth();
        //            var curren");
                WriteLiteral(@"tDate = dateFtt(""yyyy-MM-dd"", calendar.currentData.currentDate);
        ...
        navLinkDayClick: function (date, jsEvent) {
            // 这里进行日名称点击事件");
                WriteLiteral(@"处理，Ajax请求，date格式化后为当日
        },
        ...
        eventDrop: function (event, oldEvent) { //拖拽事件
            var oldEndStr = dateFtt(""yyyy-MM-d");
                WriteLiteral(@"d"", event.oldEvent.endStr);
                ...
                layui.use(['form', 'admin', 'adminForm'], function () {
                    ...
                    var adminForm = layui.adminForm;
                     adminForm.Save({
                         url:'");
#nullable restore
#line 189 "D:\YNK_Crm\WebManage\Areas\Admin\Views\Manage\CourseWork\Index.cshtml"
                         Write(Url.Action("DropCourseWork"));
...
#nullable disable
        ...
        events: function (arg, callback) {
            ...
            var subjectId = $(""select[name='");
                WriteLiteral("SubjectId\']\").val();\r\n            var projectId=$(\"select[name=\'ProjectId\']\").val()\r\n            defaultEndTime = endStr;\r\n            $.ajax({\r\n                url: \'");
#nullable restore
#line 218 "D:\YNK_Crm\WebManage\Areas\Admin\Views\Manage\CourseWork\Index.cshtml"
...
#nullable disable
                ...
                WriteLiteral(@"s.push({
                                id: result[i].Id,
                                title: result[i].Work_Title + '  教师:' + result[i].TeacherName + (result[i].RoomName != null && result[i].RoomName!=""""?'  教室:' + result[i].RoomName:''),
                                start: atStart,
                                end: atEnd,
                                display:'block',
        ...
        eventMouseEnter: function (event, el) {
            ...
            v");
                WriteLiteral(@"ar pageX = (event.jsEvent.pageX-20)+ ""px"";
    ...
    function showEditModel(wkId, dataStr,iniTable) {
        ...
        layui.use(['form', 'admin', 'adminList'], function () {
            ...
            adminList.form({
                ...
                content: wkId ? '");
#nullable restore
#line 286 "D:\YNK_Crm\WebManage\Areas\Admin\Views\Manage\CourseWork\Index.cshtml"
...
#line hidden
#nullable disable
                WriteLiteral(@"?ID=0&teacherName=' + teacherName+'&dataStr=' + dataStr,
                end: function () {
                    //重新渲染日历
                    calendar.refetchEvents();
    ...
    //}
        layui.use(['adminList', 'element', 'adminForm', 'laydate', 'form', 'table'], function () {
            ...
            url: """);
#nullable restore
#line 329 "D:\YNK_Crm\WebManage\Areas\Admin\Views\Manage\CourseWork\Index.cshtml"
...
#nullable disable
            ...
            form.on('select(SubjectId)', function (data) {
                ...
                url: """);
#nullable restore
#line 345 "D:\YNK_Crm\WebManage\Areas\Admin\Views\Manage\CourseWork\Index.cshtml"
...
#nullable disable
            ...
            var initable=adminList.tableLayUI({
                        ...
                        url: '");
#nullable restore
#line 372 "D:\YNK_Crm\WebManage\Areas\Admin\Views\Manage\CourseWork\Index.cshtml"
...
#nullable disable
                        ...
                        cols: [[
                            ...
                            },
                            {
                                field: 'StartTime', title: '时间段', sort: true, width: 120, templet: function (d) {
                                    re");
                WriteLiteral(@"turn d.StartTime + "" - "" + d.EndTime;
                                }
                            },
              ...
              ");
                WriteLiteral(@"          parseData: function (res) {
            ...
            adminList.table.on('tool(userTable)', function (obj) {
                ...
                WriteLiteral("       url:\'");
#nullable restore
#line 423 "D:\YNK_Crm\WebManage\Areas\Admin\Views\Manage\CourseWork\Index.cshtml"
...
#nullable disable
            ...
            element.on('tab(tabWork)', function (data) {
                if (data.index == 0) {
                    ...
                    initable.reload({
                        where: {
                            startStr: $(""input[name='StartTime']"").val(), endSt");
                WriteLiteral(@"r: $(""input[name='EndTime']"").val(), userName: $(""#txtTitle"").val(),
                            subjectId: $(""select[name='SubjectId']"").val(), projectId: $(""select[name='ProjectId']"").val()}
                    });
                }
            });
            ...
            $(""#btnCopy"").click(function () {
                ...
                if (checkStatus.data.length > 0) {
                    ...
                    adminForm.Save({
                        url: '");
#nullable restore
#line 457 "D:\YNK_Crm\WebManage\Areas\Admin\Views\Manage\CourseWork\Index.cshtml"
                         Write(Url.Action("CopyCourseWork"));
    ...
    function dateFtt(fmt, val) { //author: meizz
        ...
        for (var k in o)
            if (new RegExp(""("" + k + "")"").test(fmt))
                ...
                WriteLiteral(@"p.$1, (RegExp.$1.length == 1) ? (o[k]) : ((""00"" + o[k]).substr(("""" + o[k]).length)));
        return fmt;
    }
