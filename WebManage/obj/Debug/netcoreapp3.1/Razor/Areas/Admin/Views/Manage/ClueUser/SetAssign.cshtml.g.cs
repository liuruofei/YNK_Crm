#pragma checksum "D:\YNK_Crm\WebManage\Areas\Admin\Views\Manage\ClueUser\SetAssign.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "a5ebddf928582841b2a5edf2bbe27e5350539885"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Areas_Admin_Views_Manage_ClueUser_SetAssign), @"mvc.1.0.view", @"/Areas/Admin/Views/Manage/ClueUser/SetAssign.cshtml")]
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"a5ebddf928582841b2a5edf2bbe27e5350539885", @"/Areas/Admin/Views/Manage/ClueUser/SetAssign.cshtml")]
    ...
    public class Areas_Admin_Views_Manage_ClueUser_SetAssign : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
#nullable restore
#line 1 "D:\YNK_Crm\WebManage\Areas\Admin\Views\Manage\ClueUser\SetAssign.cshtml"
...
#nullable disable
            WriteLiteral("\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "a5ebddf928582841b2a5edf2bbe27e53505398855735", async() => {
                WriteLiteral("\r\n    <input name=\"ClueId\" type=\"hidden\"");
                BeginWriteAttribute("value", " value=\"", 160, "\"", 179, 1);
#nullable restore
#line 6 "D:\YNK_Crm\WebManage\Areas\Admin\Views\Manage\ClueUser\SetAssign.cshtml"
...
#nullable disable
    ...
    <div class=""layui-form-item"">
        <div class=""layui-inline"">
            <label class=""layui-form-label"">指派顾问</label>
            <div class=""layui-input-block"">
                <select name=""CC_Uid"">
                </select>
            </div>
...
");
            ...
            DefineSection("js", async() => {
                WriteLiteral("\r\n    <!-- js部分 -->\r\n    ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("link", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "a5ebddf928582841b2a5edf2bbe27e535053988511357", async() => {
                }
                );
...
#nullable restore
#line 98 "D:\YNK_Crm\WebManage\Areas\Admin\Views\Manage\ClueUser\SetAssign.cshtml"
                Write(KeyId);
        ...
        var App = {
            Load: function () {
                              adminForm.load({
                                ...
                                KeyId: '");
#nullable restore
#line 119 "D:\YNK_Crm\WebManage\Areas\Admin\Views\Manage\ClueUser\SetAssign.cshtml"
                                   Write(KeyId);
...
#nullable disable
                WriteLiteral("\',\r\n                                url: \"");
#nullable restore
#line 120 "D:\YNK_Crm\WebManage\Areas\Admin\Views\Manage\ClueUser\SetAssign.cshtml"
                ...
                WriteLiteral(@""",
                                ...
                                callBack: function (r) {
                                      ...
                                      adminForm.load({
                                            url: """);
#nullable restore
#line 130 "D:\YNK_Crm\WebManage\Areas\Admin\Views\Manage\ClueUser\SetAssign.cshtml"
...
#nullable disable
                ...
                WriteLiteral(@"primary"" name=""courseGroup"" value = ' + result[i].SubjectId + '  title = ' + result[i].SubjectName + ' /></div >');
                                      ...
                                      adminForm.load({
                                            url: """);
#nullable restore
#line 147 "D:\YNK_Crm\WebManage\Areas\Admin\Views\Manage\ClueUser\SetAssign.cshtml"
...
#nullable disable
                                                ...
                                                if (rou.data != null) {
                                                    ...
                                                    for (var i = 0; i < result.length; i++) {
                                                        if (r != undefined && r.CC_Uid != null && r.CC_Uid== result[i].User_ID) {
                                                            $(""select[name='CC_Uid']"").append('<option value = ' + result[i].User_ID + ' selected>' + result[i].User_Name +'</option>');

                                                        } else {
                                                            $(""select[name='CC_Uid']"").append('<option value = ' + result[i].User_ID + '>' + result[i].User_Name + '</option>');
                                                        }
                   ");
                WriteLiteral(@"                                 }
                                                }
            ...
            Save: function (data) {
                adminForm.Save({
                    url: KeyId ? '");
#nullable restore
#line 168 "D:\YNK_Crm\WebManage\Areas\Admin\Views\Manage\ClueUser\SetAssign.cshtml"
                             Write(Url.Action("SaveAssign"));
