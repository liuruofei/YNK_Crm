#pragma checksum "D:\YNK_Crm\WebManage\Areas\Admin\Views\Manage\CourseWork\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "068144485635303aeaced733a71a32b3f6adb4d2"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"068144485635303aeaced733a71a32b3f6adb4d2", @"/Areas/Admin/Views/Manage/CourseWork/Index.cshtml")]
...
<div style=""position:absolute;background-colo");
            WriteLiteral("r:yellowgreen\" id=\"flexPlay\"></div>\r\n");
                ...
                layui.use(['form', 'admin', 'adminForm'], function () {
                    ...
                    var adminForm = layui.adminForm;
                     adminForm.Save({
                         url:'");
#nullable restore
#line 188 "D:\YNK_Crm\WebManage\Areas\Admin\Views\Manage\CourseWork\Index.cshtml"
...
#nullable restore
#line 217 "D:\YNK_Crm\WebManage\Areas\Admin\Views\Manage\CourseWork\Index.cshtml"
...
#nullable disable
                ...
                success: function (data) {
                    ...
                    if (result.length > 0) {
                        for (var i = 0; i < result.length; i++) {
                            ...
                            events.push({
                                id: result[i].Id,
                                title: result[i].Work_Title + '  教师:' + result[i].TeacherNa");
                WriteLiteral(@"me + (result[i].RoomName != null && result[i].RoomName!=""""?'  教室:' + result[i].RoomName:''),
                                start: atStart,
                                end: atEnd,
                                display:'block',
    ...
    function showEditModel(wkId, dataStr,iniTable) {
        ...
        layui.use(['form', 'admin', 'adminList'], function () {
            ...
            adminList.form({
                title");
                WriteLiteral(": (wkId ? \'调整\' : \'添加\') + \'排课\',\r\n                type: 2,\r\n                width: \"760px\",\r\n                height: \"680px\",\r\n                content: wkId ? \'");
#nullable restore
#line 282 "D:\YNK_Crm\WebManage\Areas\Admin\Views\Manage\CourseWork\Index.cshtml"
...
#nullable disable
                WriteLiteral(@"?ID=0&teacherName=' + teacherName+'&dataStr=' + dataStr,
                    ...
                    if (iniTable != undefined && iniTable != null) {
                        iniTable.reload({
                            where: { startStr: defaultStartTime, endStr: defaultEndTime, userName: $(""#txtTitle"").val(),subjectId:$(""select[name='SubjectId']"").val(), projectId:$(""select[name='ProjectId']"").val()}
                        });
                    }
                }
            });
    ...
    //}
        layui.use(['adminList', 'element', 'adminForm', 'laydate', 'form'], function () {
            ...
            url: """);
#nullable restore
#line 316 "D:\YNK_Crm\WebManage\Areas\Admin\Views\Manage\CourseWork\Index.cshtml"
...
#nullable disable
            ...
            form.on('select(SubjectId)', function (data) {
                ...
                url: """);
#nullable restore
#line 332 "D:\YNK_Crm\WebManage\Areas\Admin\Views\Manage\CourseWork\Index.cshtml"
...
#nullable disable
            ...
            var initable=adminList.tableLayUI({
                        ...
                        url: '");
#nullable restore
#line 359 "D:\YNK_Crm\WebManage\Areas\Admin\Views\Manage\CourseWork\Index.cshtml"
                        ...
                        cols: [[
                            ...
                            },
                            {
                                field: 'StartTime', title: '时间段', sort: true, width: 120, templet: function (d) {
                                    ret");
                WriteLiteral(@"urn d.StartTime + "" - "" + d.EndTime;
                                }
                            },
                        ...
                        if (layEvent === 'edit') { // 修改
                            showEditModel(data.Id, '', initable);
                             ...
                             adminForm.Save({
                                 url:'");
#nullable restore
#line 406 "D:\YNK_Crm\WebManage\Areas\Admin\Views\Manage\CourseWork\Index.cshtml"
...
");
    ...
    function dateFormat(fmt, datestr) {
        ...
        const opt = {
            ""Y+"": date.getF");
                WriteLiteral(@"ullYear().toString(),        // 年
