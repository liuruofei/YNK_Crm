#pragma checksum "D:\Dingzhihua2\WebManage\Areas\Admin\Views\Manage\Users\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "a953835a390aaf2308cf530088ee390369695452"
// <auto-generated/>
...
layui.use(['form', 'util', 'admin', 'adminList'], function () {
    ...
    var insTb = adminList.tableLayUI({
        ...
        url: '");
#nullable restore
#line 55 "D:\Dingzhihua2\WebManage\Areas\Admin\Views\Manage\Users\Index.cshtml"
    ...
    adminList.table.on('tool(userTable)', function (obj) {
        ...
        if (layEvent === 'del') { //  删除
            doDel(data.Id);");
                WriteLiteral("\r\n        } \r\n    });\r\n    //删除\r\n    function doDel(Id) {\r\n        adminList.delete(\'");
#nullable restore
#line 94 "D:\Dingzhihua2\WebManage\Areas\Admin\Views\Manage\Users\Index.cshtml"
